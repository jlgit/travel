...
const WhyChoose = () => {
  return (
    <div className='w-[80%] mx-auto'>
        <SectionHeading heading="Why choose us" subheading="Experiance and Reliance is our Passion" />
        <div className='grid w-[80%] mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-16 items-center mt-20'>
          <div data-aos="fade-up" data-aos-anchor-placement="top-center">
            <WhyChooseCard image="/images/c1.svg" title="Best Price Guaranted" />
          </div>
          ...
          <div data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-delay="300">
            <WhyChooseCard image="/images/c3.svg" title="Customer Care24//7" />
          </div>
        </div>
    </div>
  )
