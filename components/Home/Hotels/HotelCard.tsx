...
const HotelCard = ({hotel}: Props) => {
    return (
        <div>
            ...
            <div>
                <h2 className='mt-4 text-lg font-semibold text-blue-950 hover:text-black cursor-pointer transition-all duration-200'>
                    {hotel.name}
                </h2>
                ...
                <p className='mt-3 text-gray-700 font-medium'>
                    Starting at: <span className='text-blue-600 font-bold'>${hotel.price}</span>
                </p>
            </div>
        </div>
    )
